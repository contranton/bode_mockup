...
uint8_t USART_Init(struct USART_configuration config)
{
    ...
    {
    case 1200: UCA0CTL1 |= UCSSEL0; UCA0BR0 = 27; UCA0BR1 = 0; UCA0MCTL |= UCBRS1; break;
    case 2400: UCA0CTL1 |= UCSSEL0; UCA0BR0 = 13; UCA0BR1 = 0; UCA0MCTL |= UCBRS1+UCBRS2; break;
    case 4800: UCA0CTL1 |= UCSSEL0; UCA0BR0 = 6; UCA0BR1 = 0; UCA0MCTL |= UCBRS0+UCBRS1+UCBRS2; break;
    case 9600: UCA0CTL1 |= UCSSEL1; UCA0BR0 = 109; UCA0BR1 = 0; UCA0MCTL |= UCBRS0; break;
    case 19200: UCA0CTL1 |= UCSSEL1; UCA0BR0 = 54; UCA0BR1 = 0; break;
    case 57600: UCA0CTL1 |= UCSSEL1; UCA0BR0 = 18; UCA0BR1 = 0; UCA0MCTL |= UCBRS0+UCBRS1; break;
    case 115200: UCA0CTL1 |= UCSSEL1; UCA0BR0 = 9; UCA0BR1 = 0; UCA0MCTL |= UCBRS2+UCBRS1; break;
    default:
        flag |= BIT3;
        break;
    }
    ...
    case 5: break;
    case 6: break;
    case 7: UCA0CTL0 |= UC7BIT; break;
    case 8: UCA0CTL0 &= ~UC7BIT; break;
    default:
        flag |= BIT2;
        break;
    }
    ...
    {
    case 'N': UCA0CTL0 &= ~UCPEN; break;
    case 'E': UCA0CTL0 |= UCPEN; UCA0CTL0 |= UCPAR; break;
    case 'O': UCA0CTL0 |= UCPEN; UCA0CTL0 &= ~UCPAR; break;
    default:
        flag |= BIT1;
        break;
    }
    ...
    {
    case 1: UCA0CTL0 &= ~UCSPB; break;
    case 2: UCA0CTL0 |= UCSPB; break;
    default:
        flag |= BIT0;
        break;
    }
...
{
    // A nice hint: With interrupts, you can send bytes whenever the register UCA0TXBUF
    // is free. And there is an interrupt called UCTXIFG that *tells you*
    // whenever UCA0TXBUF is free.
